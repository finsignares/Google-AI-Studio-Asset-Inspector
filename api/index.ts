...
${
  isFollowUp
            ...
            device: {
              ...
              properties: {
                deviceType: {
                  type: Type.STRING,
                  description:
                    "Identified device name (e.g., 'Business Laptop', 'Cordless Hammer Drill')",
                },
                ...
                brand: {
                  type: Type.STRING,
                  description:
                    "Brand name or 'Unidentified / Generic'",
                },

                model: {
                  type: Type.STRING,
                  description:
                    "Model name/number or best estimate",
                },
                ...
                serialNumberOrTag: {
                  ...
                  properties: {
                    ...
                    value: {
                      type: Type.STRING,
                      description:
                        "Serial number string or null if unreadable",
                    },

                    locationNotes: {
                      type: Type.STRING,
                      description:
                        "Where the label is or should be located",
                    },
                ...
                summary: {
                  type: Type.STRING,
                  description:
                    "Concise 1-2 sentence overview of the device",
                },
              },
                  ...
                  items: {
                    ...
                    properties: {
                      name: {
                        type: Type.STRING,
                        description:
                          "Name of the accessory, e.g., '65W Power Adapter', 'Battery Pack'",
                      },
            ...
            sufficiency: {
              ...
              properties: {
                isAuditComplete: {
                  type: Type.BOOLEAN,
                  description:
                    "True if all necessary information to certify the device is complete. False if additional video angles or details are required.",
                },

                confidenceScore: {
                  type: Type.NUMBER,
                  description:
                    "0 to 100 confidence in evaluation",
                },
                  ...
                  items: {
                    ...
                    properties: {
                      ...
                      userInstruction: {
                        type: Type.STRING,
                        description:
                          "Direct clear instructions to the user on what to record next or provide",
                      },

                      reason: {
                        type: Type.STRING,
                        description:
                          "Why this additional information is needed",
                      },
                    },
    ...
    return res.status(500).json({
      error:
        error?.message ||
        "Failed to inspect device video frames.",
    });
  }
});
